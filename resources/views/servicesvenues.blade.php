...
<!-- Head Section -->
<head>
  <title>Peace of Cake Services and Venues</title>
  <!-- Meta Tags -->
  <meta charset="UTF-8">
...
<div id="navBig" class="w3-top">
  <ul class="w3-navbar w3-theme-d2 w3-left-align">
    ...
    <li class="w3-hide-small w3-mobile"><a href="/servicesvenues" class="w3-light-grey">Services and Venues</a></li>
  ...
  <div id="navSmall" class="w3-hide w3-hide-large w3-hide-medium">
    <ul class="w3-navbar w3-left-align w3-theme-d2">
      ...
      <li><a href="/servicesvenues" class="w3-light-grey">Services and Venues</a></li>
...
<div id="background" class="w3-sand w3-padding-64">


<!-- Services and Venues Section -->
<div id="typesServicesVenues" class="w3-container">
  <h3 class="w3-center">We offer many types of services and can help with different types of venues</h3>
  <p class="w3-center w3-large">Types offered:</p>
...
<div id="footer" class="w3-cell-row w3-theme-d2">
  <div class="w3-container w3-cell w3-left w3-theme-d2">
	...
	<br><a href="#servicesVenuesPage" class="w3-hover-opacity">Return to Top</a>
	</p>
  </div>
